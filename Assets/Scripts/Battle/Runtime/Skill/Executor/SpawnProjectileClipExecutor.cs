...
namespace Battle
{
    ...
    public sealed class SpawnProjectileClipExecutor : BattleSkillNodeExecutor<SpawnProjectileNodeData>
    {
        ...
        {
            Debug.Log($"[SkillTest] {nameof(SpawnProjectileNodeData)} @ elapsed={context.ElapsedTicks} clipId={context.Node.ClipId} domain=ServerAuthority: {JsonUtility.ToJson(data)}");
